...
data = {
    'account_id': '001Ip00000AUhLzIAL',
    'user_ids': ['005Ip000000XkyUIAS', '005Ip000000Xky5IAC'],
    'product_ids': [],
    'transcript': 'This is a test to see how the email is being ingested and how the thread\nanalysis is being saved in the database.\nOk, it should be ingested. I will be back in around a couple of hours.\nSaturday mornings are family time for me.'
}

config = {
    'url_domain': 'https://trilogy-sales--partial.sandbox.my.salesforce.com',
    'access_token': '00DIp0000000U1D!AQsAQJJbfFl0vi75Cqi6pFnWMq_QX9GoZQK_Okrj5xqKako.x4ttAbeDLLKPbcR2_xZSJe29SzxlJj9s7R6x9kPczANzf26R',
